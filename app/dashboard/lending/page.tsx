...
export default function LendingDashboard() {
  ...
  if (!isEnabled('LENDING_DASHBOARD')) {
    return (
      <div className="max-w-4xl mx-auto p-4 py-12">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
          <div className="text-4xl mb-4">🚧</div>
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Feature Temporarily Disabled</h2>
          <p className="text-gray-700 mb-4">
            The lending dashboard is currently disabled as part of our MVP stability improvements.
          </p>
          <p className="text-gray-600 text-sm">
            Core features like borrowing and loan repayment continue to work normally.
          </p>
          <a
            href="/explore"
            className="inline-block mt-4 bg-[#6936F5] text-white px-4 py-2 rounded-lg hover:bg-[#5929cc] transition"
          >
            Browse Active Loans
          </a>
        </div>
